...
class Biisi():
    ...
    '''
    TYYPPI = "biisi"
    SALLITUT_PAATTEET = [ # vain äänitiedostot
            "mp3",
            "flac",
            "wma",
            "ogg"
    ...
    def lue_tiedostosta(self, tiedostopolku):
        ...
        if paate in Biisi.SALLITUT_PAATTEET:
            ...
            if paate == "mp3":
                ...
                elif (tagit.get("tracktotal")
                    and all(a.isnumeric for a in tagit.get("tracktotal")[0])
                    ):
                    try:
    ...
    def paivays(self, lue=None):
        ...
        if isinstance(lue, (int, str)):
            stringiversio = str(lue)
            if (len(stringiversio) == 12
                and all(a.isnumeric for a in stringiversio)
                ):
        ...
        # Nykyhetken päiväys
            ...
            kokoversio = int("{:04d}{:02d}{:02d}{:02d}{:02d}".format(
                vuosi,kuukausi,paiva,tunnit,minuutit)
                )
    ...
    def __gt__(self, other):
        '''
        Suuremmuusvertailu: uudempi voittaa aina.
        '''
        if self.lisayspaiva > other.lisayspaiva:
            return True
        return False
